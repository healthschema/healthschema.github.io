...
**As of 2015, GitHub reports over 9 million users and over 21.1 million repositories, making it the largest host of source code in the World. The worlds largest software companies all use Github to develop and manage their code (Google, Microsoft, Adobe, Twitter, PayPal, Amazon, Yahoo, LinkedIn, Facebook, Dropbox, Mozilla)**
