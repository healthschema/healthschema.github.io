...
**As of 2015, GitHub reports over 9 million users and over 21.1 million repositories, making it the largest host of source code in the World. It is the collaborative code management platform of the world's largest software development companies (Google, Microsoft, Adobe, Twitter, PayPal, Amazon, Yahoo, LinkedIn, Facebook, Dropbox, Mozilla)**.
